    ...
    return (
        ...
        >
            <div className="relative w-20 h-24 mb-3">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-label-primary z-10 pt-1">
...
export default function BlockchainPage() {
    return (
        <motion.div variants={container} initial="hidden" animate="show" className="max-w-[1400px] mx-auto space-y-6">
            ...
            {/* ----- HEADER ----- */}
            <motion.div variants={item} className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-[var(--liquid-glass-border)] pb-6 relative">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="bg-[var(--liquid-glass-bg)] border border-[rgba(255,255,255,0.1)] text-label-primary rounded-full pl-9 pr-4 py-2 text-[14px] focus:outline-none focus:ring-1 focus:ring-ios-blue transition-all w-full md:w-72 backdrop-blur-xl"
                        />
                    </div>
                </div>
            </motion.div>
            ...
            <motion.div variants={item} className="liquid-glass-card rounded-[24px] p-8 border border-[var(--liquid-glass-border)] bg-[rgba(20,20,22,0.4)] relative overflow-hidden flex items-center justify-center min-h-[200px]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                    ...
                    <motion.div key={i} variants={item} className="liquid-glass-card p-5 rounded-[20px] border border-[var(--liquid-glass-border)] bg-[rgba(20,20,22,0.4)] relative group flex items-start justify-between">
                        ...
                        <div>
                            ...
                            <p className="text-[17px] font-bold text-label-primary tracking-tight">{stat.value}</p>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <motion.div variants={item} className="lg:col-span-2 liquid-glass-card rounded-[24px] p-6 border border-[var(--liquid-glass-border)] bg-[rgba(20,20,22,0.4)] relative">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="text-[18px] font-bold text-label-primary tracking-tight">Transaction Explorer</h3>
                        </div>
                        <button className="text-[13px] text-ios-blue hover:text-label-primary transition-colors font-medium bg-[var(--liquid-glass-bg)] border border-[var(--liquid-glass-border)] px-3 py-1.5 rounded-lg">
                            Live Feed
                        </button>
                    </div>
                            ...
                            <tbody>
                                {recentTransactions.map((tx, i) => (
                                    <motion.tr
                                        ...
                                        className="border-b border-[var(--liquid-glass-border)] hover:bg-[rgba(255,255,255,0.02)] transition-colors group/row cursor-pointer"
                                    >
                                        ...
                                        <td className="py-4 px-4 text-[13px] text-label-primary">
                                            {tx.value}
                                        </td>
                                        <td className="py-4 px-4">
                ...
                <motion.div variants={item} className="w-full flex flex-col gap-6">
                    <div className="liquid-glass-card rounded-[24px] p-6 border border-[var(--liquid-glass-border)] bg-[rgba(20,20,22,0.4)] relative overflow-hidden">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="text-[18px] font-bold text-label-primary tracking-tight">Verified Contracts</h3>
                            </div>
                        </div>

                        <div className="space-y-3">
                            {smartContracts.map((contract, i) => (
                                <div key={i} className="bg-[rgba(255,255,255,0.03)] border border-[var(--liquid-glass-border)] rounded-[16px] p-4 hover:bg-[var(--liquid-glass-bg)] transition-colors group">
                                    <div className="flex items-start justify-between mb-2">
                                        <div className="flex items-center gap-2">
                                            <span className="text-[18px]">{contract.icon}</span>
                                            <h4 className="text-[14px] font-semibold text-label-primary tracking-tight group-hover:text-ios-blue transition-colors">
                                                {contract.name}
                                            </h4>
                                        </div>
                                    ...
                                    <div className="flex flex-col gap-1.5 mt-3">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-[12px] font-mono text-label-primary flex items-center gap-1">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-[12px] text-label-primary font-medium">
